...
# --- COMPONENTE INVISÍVEL PARA DISPARAR O POP-UP DO GOOGLE ---
# O uso de 'enableHighAccuracy: true' é o que força a janela de "Precisão de Local"
components.html("""
    <script>
...
# --- INTERFACE (CONFORME SEUS PRINTS) ---
