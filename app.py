...
st.markdown("""
    <style>
        ...
        .stButton > button {
            width: 100%; background-color: #3b82f6 !important;
            color: white !important; font-weight: 600; border-radius: 4px;
        }
    </style>
...
# --- O RODAPÉ QUE VOCÊ PEDIU ---
st.markdown("""
    <div class="cyber-footer">
        <div class="cyber-title">
            🛡️ 2026 MIAMYSEGURANÇA ® TODOS OS DIREITOS RESERVADOS.
        </div>
